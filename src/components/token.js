...
<div className='token__section'>
	...
	<div className='bottom-space-sm' />
		...
		<div className='row' style={{flexFlow: 'row', alignItems:'center'}}>
			<div className='col'>
				<h3 style={{fontSize: '19px', margin: '0px 0px 0px 0px', opacity:1,  letterSpacing: '0.35em'}}>6% BUY</h3>
			</div>
			<div className='col'>
				<h3 style={{fontSize: '19px', margin: '0px 0px 0px 0px', opacity:1,  letterSpacing: '0.35em'}}>&emsp;|&emsp;</h3>
			</div>
			<div className='col'>
				<h3 style={{fontSize: '19px', margin: '0px 0px 0px 0px', opacity:1,  letterSpacing: '0.35em'}}>SELL 7%</h3>
			</div>
		</div>
		...
		<div className='bottom-space-md' />
			...
			<h3 style={{fontSize: '15px', margin: '2px', opacity:1}}>HODL minimum 20 MILLION $DOGE-1</h3>
			<h3 style={{fontSize: '12px', margin: '5px', opacity:1}}>to receive DOGECOIN rewards automatically</h3>
		</div>
